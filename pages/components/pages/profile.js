                  ...
                  <Row>
                    <div className="">
                      <div className="social social-profile-buttons mt-5 float-end">
                        <div className="mt-3">
                          <Link href="#!" className="social-icon text-primary me-2" ><i className="fa fa-facebook"></i></Link>
                          <Link href="#!" className="social-icon text-primary me-2"><i className="fa fa-twitter"></i></Link>
                          <Link href="#!" className="social-icon text-primary me-2"><i className="fa fa-youtube"></i></Link>
                          <Link href="#!" className="social-icon text-primary me-2"><i className="fa fa-rss"></i></Link>
                          <Link href="#!" className="social-icon text-primary me-2"><i className="fa fa-linkedin"></i></Link>
                          <Link href="#!" className="social-icon text-primary me-2"><i className="fa fa-google-plus"></i></Link>
                        </div>
                      </div>
                    </div>
                  </Row>
