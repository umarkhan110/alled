...
import { shopingData } from '../../../shared/data/data-ecommerce/datashoppingcart';
import { connect } from "react-redux";
import { AddToCart, ProductReduxData } from "../../../shared/redux/action";
import Seo from '@/shared/layout-components/seo/seo';
import { useRouter } from 'next/router';

const ShoppingCart = ({ localVaraiable }) => {
                    ...
                    <tr key={Math.random()}>
                        <td>
                            <div className="text-center">
                             <img src={`${process.env.NODE_ENV === 'production'? basePath : ''}${list.preview}`} alt="img" className="cart-img text-center" />
                            </div> 
                         </td>     
                        <td>{list.heading}</td>  
