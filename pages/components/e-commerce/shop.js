                ...
                <Card.Body>
                  ...
                  <div className="d-flex">
                    <Card.Body className="px-0">
                      <Slider onChange={(ele)=>handleChange(ele.target.value)} defaultValue={[100, 370]} min={20} max={670} marks={Mark} />
                    </Card.Body>
                  </div>
                </Card.Body>
              </Card>
                                ...
                                <div className="product-grid6">
                                  <div className="product-image6 p-5">
                                    ...
                                    <Link href={`/components/e-commerce/product-details/`} >
                                      <img className="img-fluid br-7 w-100" src={`${process.env.NODE_ENV === 'production'? basePath : ''}${idx.preview}`} alt="img" />
                                    </Link>
                                  </div>
                                      ...
                                      <div className="product-list">
                                        ...
                                        <div className="br-be-0 br-te-0">
                                          <Link href={`/components/e-commerce/product-details/`} className="">
                                            <img src={`${process.env.NODE_ENV === 'production'? basePath : ''}${idx.preview}`} alt="img" className="cover-image br-7 w-100" />
                                          </Link>
                                        </div>
                                      </div>
                                    </Col>
