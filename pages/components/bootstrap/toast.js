          ...
          <Card>
            <Card.Header>
              ...
              <Form className="ms-auto">
                <Form.Check type="switch" label="Show Code" id="custom-switch" onClick={() => setBasic(!Basic)} className="showcode mt-1 d-inline-flex align-items-center ms-auto mx-2" />
              </Form>
            </Card.Header>
            <Card.Body>
              <div className="p-4">
        ...
        <Col xl={6} md={12}>
          <Card>
            <Card.Header>
              ...
              <Form className="ms-auto">
                <Form.Check type="switch" label="Show Code" id="custom-switch" onClick={() => setTranslucent(!Translucent)} className="showcode mt-1 d-inline-flex align-items-center ms-auto mx-2" />
              </Form>
            </Card.Header>
            <Card.Body>
        ...
        <Col xl={6} md={12}>
          <Card>
            <Card.Header>
              ...
              <Form className="ms-auto">
                <Form.Check type="switch" label="Show Code" id="custom-switch" onClick={() => setCustom(!Custom)} className="showcode mt-1 d-inline-flex align-items-center ms-auto mx-2" />
              </Form>
            </Card.Header>
            <Card.Body>
              <Row>
                <Col md={12} xl={6} className="mt-1">
                  <Toast show={contentShow} onClose={togglecontentShow}>
                    <Toast.Header className="border-bottom-0 br-5">
        ...
        <Col xl={6} md={12}>
          <Card>
            <Card.Header>
              ...
              <Form className="ms-auto">
                <Form.Check type="switch" label="Show Code" id="custom-switch" onClick={() => setColor(!Color)} className="showcode mt-1 d-inline-flex align-items-center ms-auto mx-2" />
              </Form>
            </Card.Header>
            <Card.Body>
              <Row>
                <Col md={6}>
                  <div className="toast align-items-center text-white bg-primary border-0 show" role="alert" aria-live="assertive" aria-atomic="true" data-bs-autohide="false">
                    <div>
                      ...
                      <Toast show={colourShow} onClose={togglecolourShow} className="br-5 colored-toast">
                ...
                <Col md={6} className="mt-2 mt-md-0">
                  <div className="toast align-items-center text-white bg-secondary border-0 show" role="alert" aria-live="assertive" aria-atomic="true" data-bs-autohide="false">
                    <div>
                      <Toast show={colourShow2} onClose={togglecolourShow2} className="br-5 colored-toast">
                ...
                <Col md={6} className="mt-2">
                  <div className="toast align-items-center text-white bg-success border-0 show" role="alert" aria-live="assertive" aria-atomic="true" data-bs-autohide="false">
                    <div>
                      ...
                      <Toast show={colourShow3} onClose={togglecolourShow3} className="br-5 colored-toast">
                ...
                <Col md={6} className="mt-2">
                  <div className="toast align-items-center text-white bg-danger border-0 show" role="alert" aria-live="assertive" aria-atomic="true" data-bs-autohide="false">
                    <div>
                      ...
                      <Toast show={colourShow3} onClose={togglecolourShow4} className="br-5 colored-toast">
        ...
        <Col xl={6} md={12}>
          <Card>
            <Card.Header>
              ...
              <Form className="ms-auto">
                <Form.Check type="switch" label="Show Code" id="custom-switch" onClick={() => setStacking(!Stacking)} className="showcode mt-1 d-inline-flex align-items-center ms-auto mx-2" />
              </Form>
            </Card.Header>
            <Card.Body>
              <div className="p-4 bg-light border">
        ...
        <Col xl={6} md={12}>
          <Card>
            <Card.Header>
              ...
              <Form className="ms-auto">
                <Form.Check type="switch" label="Show Code" id="custom-switch" onClick={() => setPlacement(!Placement)} className="showcode mt-1 d-inline-flex align-items-center ms-auto mx-2 text-nowrap" />
              </Form>
            </Card.Header>
            <Card.Body>
              <div className="p-4 bg-light border">
