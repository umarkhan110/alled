            ...
            <Row>
              <Col lg={6}>
                <Link className="header-brand" href={`/components/dashboard/dashboard/`}>
                  <img src={`${process.env.NODE_ENV === 'production'? basePath : ''}/assets/images/brand/logo-dark.png`} className="header-brand-img logo-3 m-0" alt="Sash logo" />
                  <img src={`${process.env.NODE_ENV === 'production'? basePath : ''}/assets/images/brand/logo-white.png`} className="header-brand-img logo m-0" alt="Sash logo" />
                </Link>
                <div>
