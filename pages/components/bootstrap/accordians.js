          ...
          <Card>
            <Card.Header className='d-sm-flex justify-content-between align-items-center d-block'>
              ...
              <Form className="ms-auto">
                <Form.Check type="switch" label="Show Code" id="custom-switch" onClick={() => setdefaultCode(!defaultCode)} className="showcode align-items-center d-flex ms-auto mx-2" />
              </Form>
            </Card.Header>
        ...
        <Col sm={12} md={12} lg={12} xl={12}>
          <Card>
            <Card.Header>
              ...
              <Form className="ms-auto">
                <Form.Check type="switch" label="Show Code" id="custom-switch" onClick={() => setBootstrapCode(!bootstrapCode)} className="showcode align-items-center d-flex ms-auto mx-2" />
              </Form>
            </Card.Header>
            <Card.Body>
        ...
        <Col sm={12} md={12} lg={12} xl={12}>
          <Card>
            <Card.Header>
              ...
              <Form className="ms-auto">
                <Form.Check type="switch" label="Show Code" id="custom-switch" onClick={() => setClosedIconCode(!ClosedIconCode)} className="showcode align-items-center d-flex ms-auto mx-2" />
              </Form>
            </Card.Header>
            <Card.Body>
        ...
        <Col lg={12}>
          <Card>
            <Card.Header className='d-sm-flex justify-content-between align-items-center d-block'>
              ...
              <Form className="ms-auto">
                <Form.Check type="switch" label="Show Code" id="custom-switch" onClick={() => setStyled1Code(!Styled1Code)} className="showcode align-items-center d-flex ms-auto mx-2" />
              </Form>
            </Card.Header>
            <Card.Body>
...
`}
          ...
          <Card>
            <Card.Header className='d-sm-flex justify-content-between align-items-center d-block'>
              ...
              <Form className="ms-auto">
                <Form.Check type="switch" label="Show Code" id="custom-switch" onClick={() => setindivisual(!indivisual)} className="showcode align-items-center d-flex ms-auto mx-2" />
              </Form>
            </Card.Header>
            <Card.Body>
