...
import { TotalUser, TotalProfit, TotalExpenses, TotalCost, AllProduct, Shipped, Cancelled,Pending, SalesAnalytics, RecentOrder } from '../../../shared/data/datadashboard/dashboarddata';
const WorldMapCom = dynamic(() => import('@/shared/data/datadashboard/worldmap'), { ssr: false });
              ...
              <ul className="task-list">
                <li className="d-sm-flex">
                  <div>
                    ...
                    <h6 className="fw-semibold">Task Finished<span
                      className="text-muted fs-11 ms-2 fw-normal d-inline-flex">09 July</span>
                    </h6>
                ...
                <li className="d-sm-flex">
                  <div>
                    ...
                    <h6 className="fw-semibold">New Comment<span
                      className="text-muted fs-11 ms-2 fw-normal d-inline-flex">05 July</span>
                    </h6>
                ...
                <li className="d-sm-flex">
                  <div>
                    ...
                    <h6 className="fw-semibold">New Comment<span
                      className="text-muted fs-11 ms-2 fw-normal d-inline-flex">25 June</span>
                    </h6>
                    <p className="text-muted fs-12">Victoria commented on Project <Link
                      href="#!" className="fw-semibold"> AngularJS Template</Link></p>
                  </div>
                ...
                <li className="d-sm-flex">
                  <div>
                    ...
                    <h6 className="fw-semibold">Task Overdue<span
                      className="text-muted fs-11 ms-2 fw-normal d-inline-flex">14 June</span>
                    </h6>
                ...
                <li className="d-sm-flex">
                  <div>
                    ...
                    <h6 className="fw-semibold">Task Overdue<span
                      className="text-muted fs-11 ms-2 fw-normal d-inline-flex">29 June</span>
                    </h6>
                    <p className="text-muted mb-0 fs-12">Petey Cruiser finished task <Link
                      href="#!" className="fw-semibold"> Integrated management</Link></p>
                  </div>
