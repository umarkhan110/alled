...
const BlogDetails = () => {
  ...
  <div >
    ...
    <Row>
      <Col xl={8}>
        <Card>
          <img className="card-img-top " src={`${process.env.NODE_ENV === 'production'? basePath : ''}/assets/images/media/27.jpg`} alt="blog11" />
          <Card.Body>
          ...
          <Card.Body className="pb-0">
            <div className="media mb-5 overflow-visible d-block d-sm-flex">
              <div className="me-3 mb-2">
                <Link href={`/components/pages/profile/`}> <img className="media-object rounded-circle thumb-sm" alt="64x64" src={`${process.env.NODE_ENV === 'production'? basePath : ''}/assets/images/users/5.jpg`} /> </Link>
              </div>
              <div className="media-body overflow-visible">
                ...
                <div className="media mb-5 overflow-visible">
                  <div className="me-3">
                    <Link href={`/components/pages/profile/`}> <img className="media-object rounded-circle thumb-sm" alt="64x64" src={`${process.env.NODE_ENV === 'production'? basePath : ''}/assets/images/users/2.jpg`} /> </Link>
                  </div>
            ...
            <div className="media mb-5 overflow-visible">
              <div className="me-3">
                <Link href={`/components/pages/profile/`}> <img className="media-object rounded-circle thumb-sm" alt="64x64" src={`${process.env.NODE_ENV === 'production'? basePath : ''}/assets/images/users/15.jpg`} /> </Link>
              </div>
              <div className="media-body overflow-visible">
                <div className="border mb-5 p-4 br-5">
                ...
                <div className="media mb-5 overflow-visible d-block d-sm-flex">
                  ...
                  <div className="media-body overflow-visible">
                    ...
                    <div className="media overflow-visible">
                      <div className="me-3">
                        <Link href={`/components/pages/profile/`}> <img className="media-object rounded-circle thumb-sm" alt="64x64" src={`${process.env.NODE_ENV === 'production'? basePath : ''}/assets/images/users/9.jpg`} /> </Link>
                      </div>
                      <div className="media-body border p-4 overflow-visible br-5">
                        <nav className="nav float-end">
                          <Dropdown>
        ...
        <Card>
          ...
          <Card.Body>
            <Form className="form-horizontal  m-t-20">
              ...
              <Form.Group className='mb-3'>
                <Col xs={12}>
                  <Form.Control placeholder='Your Comment*' as='textarea' rows={5}></Form.Control>
                </Col>
              </Form.Group>
              <div className="">
          ...
          <Card.Body>
            <div className="">
              <div className="d-flex overflow-visible">
                <img className="avatar bradius avatar-xl me-3" src={`${process.env.NODE_ENV === 'production'? basePath : ''}/assets/images/users/1.jpg`} alt="avatar-img" />
              ...
              <div className="d-flex overflow-visible mt-5">
                <img className="avatar bradius avatar-xl me-3" src={`${process.env.NODE_ENV === 'production'? basePath : ''}/assets/images/users/3.jpg`} alt="avatar-img" />
                <div className="media-body valign-middle">
              ...
              <div className="d-flex overflow-visible mt-5">
                <img className="avatar bradius avatar-xl me-3" src={`${process.env.NODE_ENV === 'production'? basePath : ''}/assets/images/users/5.jpg`} alt="avatar-img" />
                <div className="media-body valign-middle">
              ...
              <div className="d-flex overflow-visible mt-5">
                <img className="avatar bradius avatar-xl me-3" src={`${process.env.NODE_ENV === 'production'? basePath : ''}/assets/images/users/15.jpg`} alt="avatar-img" />
                <div className="media-body valign-middle">
          ...
          <Card.Body>
            <div className="">
              ...
              <div className="d-sm-flex overflow-visible mt-5">
                <img className="card-aside-column br-5 cover-image" alt='media22' src={`${process.env.NODE_ENV === 'production'? basePath : ''}/assets/images/media/22.jpg`} />
                <div className="ps-3 flex-column">
              ...
              <div className="d-sm-flex overflow-visible mt-5">
                <img className="card-aside-column br-5 cover-image" alt='media12' src={`${process.env.NODE_ENV === 'production'? basePath : ''}/assets/images/media/12.jpg`} />
                <div className="ps-3 flex-column">
                  <h4><Link href={`/components/pages/extension/blog-details/`}>Generator on the Internet..</Link></h4>
                  <div className="text-muted">Excepteur sint occaecat cupidatat non proident, accusantium sunt in culpa qui officia deserunt mollit anim id est laborum....</div>
                </div>
              ...
              <div className="d-sm-flex overflow-visible mt-5">
                <img className="card-aside-column br-5 cover-image" alt='media25' src={`${process.env.NODE_ENV === 'production'? basePath : ''}/assets/images/media/25.jpg`} />
                <div className="ps-3 flex-column">
                  <h4><Link href={`/components/pages/extension/blog-details/`}>Voluptatem quia voluptas...</Link></h4>
                  <div className="text-muted">Excepteur sint occaecat cupidatat non proident, accusantium sunt in culpa qui officia deserunt mollit anim id est laborum....</div>
                </div>
