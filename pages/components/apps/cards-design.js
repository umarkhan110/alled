          ...
          {contactShow1 ? <Card className="border p-0">
            <Card.Header>
              ...
              <div className="card-options">
                <Link href="#!" onClick={contactHandleExpandClick}> <i className={`fe ${contactExpanded1 ? 'fe-chevron-up' : 'fe-chevron-down'}`}></i></Link>
                <Link href="#!" onClick={() => setcontactShow1(false)} aria-label="close"><i className="fe fe-x"></i></Link>
              </div>
            </Card.Header>
            <Collapse in={contactExpanded1} timeout={3000}>
              <div>
                <Card.Body className="text-center">
                  <img className="avatar-xxl brround cover-image" src={"../../../assets/images/users/15.jpg"} alt="user15" />
        ...
        <Col xl={3} sm={6} md={6}>
          {contactShow2 ? <Card className="border p-0">
            <Card.Header>
              <Card.Title>Contact card</Card.Title>
              <div className="card-options">
                <Link href="#!" onClick={cardHandleExpandClick2}> <i className={`fe ${cardExpanded2 ? 'fe-chevron-up' : 'fe-chevron-down'}`}></i></Link>
                <Link href="#!" onClick={() => setcontactShow2(false)} aria-label="close"><i className="fe fe-x"></i></Link>
              </div>
            </Card.Header>
        ...
        <Col xl={3} sm={6} md={6}>
          {cardShow3 ? <Card className="border p-0">
            <Card.Header>
              <Card.Title>Contact card</Card.Title>
              <div className="card-options">
                <Link href="#!" onClick={cardHandleExpandClick3}> <i className={`fe ${cardExpanded3 ? 'fe-chevron-up' : 'fe-chevron-down'}`}></i></Link>
                <Link href="#!" onClick={() => setcardShow3(false)} aria-label="close"><i className="fe fe-x"></i></Link>
              </div>
            </Card.Header>
        ...
        <Col xl={3} sm={6} md={6}>
          {cardShow4 ? <Card className="border p-0">
            <Card.Header>
              <Card.Title>Contact card</Card.Title>
              <div className="card-options">
                <Link href="#!" onClick={cardHandleExpandClick4}> <i className={`fe ${cardExpanded4 ? 'fe-chevron-up' : 'fe-chevron-down'}`}></i></Link>
                <Link href="#!" onClick={() => setcardShow4(false)} aria-label="close"><i className="fe fe-x"></i></Link>
              </div>
            </Card.Header>
          ...
          {Basicshow ? <Card>
            <Card.Header>
              ...
              <div className="card-options">
                ...
                <Link href="#!" onClick={() => setBasicshow(false)} aria-label="close"><i className="fe fe-x"></i></Link>
              </div>
            </Card.Header>
        ...
        <Col md={4} xl={4}>
          {Colorshow ? <Card>
            <Card.Header className="bg-primary br-te-3 br-ts-3">
              ...
              <div className="card-options ">
                <Link href="#!" onClick={ColorHandleExpandClick}><i className="fe fe-chevron-up text-white"></i></Link>
                <Link href="#!" onClick={() => setColorshow(false)} aria-label="close"><i className="fe fe-x text-white"></i></Link>
              </div>
            </Card.Header>
        ...
        <Col md={4} xl={4}>
          {Footershow ? <Card>
            <Card.Header>
              ...
              <div className="card-options">
                <Link href="#!" onClick={FooterHandleExpandClick}> <i className={`fe ${FooterExpanded ? 'fe-chevron-up' : 'fe-chevron-down'}`}></i></Link>
                <Link href="#!" onClick={() => setFootershow(false)} aria-label="close"><i className="fe fe-x"></i></Link>
              </div>
            </Card.Header>
        ...
        <Col md={6} xl={6}>
          <Card>
            <Card.Header>
              ...
              <div className="card-options">
                <Link href="#!" className="btn btn-primary btn-sm">Action 1</Link>
                <Link href="#!" className="btn btn-secondary btn-sm ms-2">Action 2</Link>
              </div>
            </Card.Header>
            <Card.Body>
        ...
        <Col md={6} xl={6}>
          {successshow ? <Card>
            <Card.Header>
              ...
              <div className="card-options">
                <Link href="#!" onClick={successHandleExpandClick}> <i className={`fe ${successExpanded ? 'fe-chevron-up' : 'fe-chevron-down'}`}></i></Link>
                <Link href="#!" onClick={() => setsuccessShow(false)} aria-label="close"><i className="fe fe-x"></i></Link>
              </div>
            </Card.Header>
            <Collapse in={successExpanded} timeout={3000}>
              <div>
                <Alert variant="success" className="mb-0 card-alert">
        ...
        <Col md={6} xl={6}>
          {dangershow ? <Card>
            <Card.Header>
              <Card.Title>Card with alert</Card.Title>
              <div className="card-options">
                <Link href="#!" onClick={dangerHandleExpandClick}> <i className={`fe ${dangerExpanded ? 'fe-chevron-up' : 'fe-chevron-down'}`}></i></Link>
                <Link href="#!" onClick={() => setdangerShow(false)} aria-label="close"><i className="fe fe-x"></i></Link>
              </div>
            </Card.Header>
            <Collapse in={dangerExpanded} timeout={3000}>
              <div>
                <Alert variant="danger" className="mb-0 card-alert">
          ...
          {shows ? <Card>
            <Card.Header>
              ...
              <div className="card-options">
                ...
                <Link href="#!" onClick={FullscreenhandleExpandClick}> <i className={`fe ${screenExpanded ? 'fe-chevron-up' : 'fe-chevron-down'}`}></i></Link>
                <Link href="#!" onClick={() => handleShow(true)}><i className="fe fe-maximize"></i></Link>

                <Link href="#!" onClick={() => setShows(false)} aria-label="close"><i className="fe fe-x"></i></Link>
                <Modal show={fullscreenshow} fullscreen={fullScreen} onHide={() => setfullscreenShow(false)}>
                  <Modal.Header>
                    <Modal.Title>Modal</Modal.Title>
                    <span className="d-flex ms-auto sashmodelright" onClick={fullscreenmodalClose}><i className='fe fe-x ms-auto' ></i></span>
                  </Modal.Header>
        ...
        <Col xl={4} md={4}>
          {Initialshow ? <Card>
            <Card.Header>
              ...
              <div className="card-options">
                <Link href="#!" onClick={InitialHandleExpandClick}> <i className={`fe ${InitialExpanded ? 'fe-chevron-up' : 'fe-chevron-down'}`}></i></Link>
      ...
      <Row>
        <Col xl={4} md={12}>
          <Card className="overflow-hidden">
            <img src={"../../../assets/images/media/8.jpg"} className="card-img-top" alt="img" />
            <Card.Body>
        ...
        <Col xl={4} md={12}>
          <Card className="overflow-hidden">
            ...
            <img src={"../../../assets/images/media/9.jpg"} className="card-img-bottom" alt="img" />
          </Card>
        </Col>
        <Col xl={4} md={12}>
          <Card>
            <img src={"../../../assets/images/media/31.jpg"} className="card-img-top" alt="img" />
        ...
        <Col md={12} xl={4}>
          {Listshow ? <Card className="m-b-20">
            <Card.Header>
              ...
              <div className="card-options">
                <Link href="#!" onClick={ListHandleExpandClick}> <i className={`fe ${ListExpanded ? 'fe-chevron-up' : 'fe-chevron-down'}`}></i></Link>
                <Link href="#!" onClick={() => setListShow(false)} aria-label="close"><i className="fe fe-x"></i></Link>
              </div>
            </Card.Header>
              ...
              <Card.Body>
                <div className="visitor-list">
                  <div className="media m-0 mt-0 border-bottom">
                    <img className="brround avatar-md me-3" alt="avatra-img" src={"../../../assets/images/users/18.jpg"} />
                    <div className="media-body">
                      <Link href="#!" className="text-default fw-semibold">John Paige</Link>
                      <p className="text-muted">Uploaded new invoices for RedBus</p>
                    </div>
                  </div>
                  <div className="media mt-2 border-bottom">
                    <img className="brround avatar-md me-3" alt="avatra-img" src={"../../../assets/images/users/20.jpg"} />
                    <div className="media-body">
                      <Link href="#!" className="text-default fw-semibold">Lillian Quinn</Link>
                  ...
                  <div className="media mt-2">
                    <img className="brround avatar-md me-3" alt="avatra-img" src={"../../../assets/images/users/18.jpg"} />
                    <div className="media-body">
                      <Link href="#!" className="text-default fw-semibold">Irene Harris</Link>
        ...
        <Col md={12} xl={4}>
          {sampleShow ? <Card className="m-b-20">
            <Card.Header>
              ...
              <div className="card-options">
                <Link href="#!" onClick={sampleHandleExpandClick}> <i className={`fe ${SampleExpanded ? 'fe-chevron-up' : 'fe-chevron-down'}`}></i></Link>
                <Link href="#!" onClick={() => setsampleShow(false)} aria-label="close"><i className="fe fe-x"></i></Link>
              </div>
            </Card.Header>
        ...
        <Col md={12} xl={4}>
          {ImageShow ? <Card className="card-blog-overlay  overflow-hidden">
            <Card.Header className="z-index2  border-transparent">
              <Card.Title className="text-white ">card-with image</Card.Title>
              <div className="card-options">
                <Link href="#!" onClick={ImageHandleExpandClick}><i className={`fe ${ImageExpanded ? 'fe-chevron-up' : 'fe-chevron-down'}`}></i></Link>
                <Link href="#!" onClick={() => setImageShow(false)} aria-label="close"><i className="fe fe-x text-white"></i></Link>
              </div>
            </Card.Header>
        ...
        <Col md={12} xl={6}>
          {cardShow ? <Card>
            ...
            <Card.Header>
              ...
              <div className="card-options">
                <Link href="#!" onClick={cardHandleExpandClick}> <i className={`fe ${cardExpanded ? 'fe-chevron-up' : 'fe-chevron-down'}`}></i></Link>
                <Link href="#!" onClick={() => setcardShow(false)} aria-label="close"><i className="fe fe-x"></i></Link>
              </div>
            </Card.Header>
        ...
        <Col md={12} xl={6}>
          {statusShow ? <Card>
            ...
            <Card.Header>
              ...
              <div className="card-options">
                <Link href="#!" onClick={statusHandleExpandClick}> <i className={`fe ${statusExpanded ? 'fe-chevron-up' : 'fe-chevron-down'}`}></i></Link>
                <Link href="#!" onClick={() => setstatusShow(false)} aria-label="close"><i className="fe fe-x"></i></Link>
              </div>
            </Card.Header>
      ...
      <Row>
        <Col md={12} xl={6}>
          <Card>
            <Row className="g-0">
              <Col md={4}>
                <img src={"../../../assets/images/media/22.jpg"} className="card-img-left h-100" alt="img" />
              </Col>
              <Col md={8}>
                <Card.Body>
                  <Card.Title>Card title</Card.Title>
        ...
        <Col md={12} xl={6}>
          <Card>
            <Row className="g-0">
              ...
              <Col md={4}>
                <img src={"../../../assets/images/media/22.jpg"} className="card-img-right h-100" alt="img" />
              </Col>
            </Row>
          </Card>
        </Col>
        ...
        <Col xl={12} md={12}>
          <div className="mb-5 card-group overflow-hidden">
            <Card className="shadow-none border-end">
              <img src={"../../../assets/images/media/22.jpg"} className="card-img-top" alt="img" />
              <Card.Body>
                <Card.Title>Card title</Card.Title>
                <Card.Text>This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</Card.Text>
                <Card.Text><small className="text-muted">Last updated 3 mins ago</small></Card.Text>
            ...
            <Card className="shadow-none border-end">
              <img src={"../../../assets/images/media/18.jpg"} className="card-img-top" alt="img" />
              <Card.Body>
                <Card.Title>Card title</Card.Title>
            ...
            <Card className="shadow-none">
              <img src={"../../../assets/images/media/6.jpg"} className="card-img-top" alt="img" />
