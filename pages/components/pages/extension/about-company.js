...
const AboutCompany = () => {
  ...
  <div >
    ...
    <Seo title="About"/>
      ...
      <Row>
        <Col lg={12}>
          <img src={`${process.env.NODE_ENV === 'production'? basePath : ''}/assets/images/media/34.jpg`} alt="team" className="br-5" />
        </Col>
      </Row>
      {/* <!-- ROW-2 CLOSED --> */}
            ...
            <Card.Body className="p-5 text-dark">
              <div className="statistics-info p-4">
                <Row>
                  ...
                  <Col xl={6}>
                    <div className="text-center">
                      <img src={`${process.env.NODE_ENV === 'production'? basePath : ''}/assets/images/media/36.png`} alt="team-s" />
                    </div>
                  </Col>
                </Row>
              </div>
      ...
      <Row className="mt-5">
        ...
        <Col xl={3} md={6} lg={6} className="mt-3">
          <Card>
            <Card.Body className="text-center">
              <img className="avatar avatar-xxl bradius cover-image" alt="user 2" src={`${process.env.NODE_ENV === 'production'? basePath : ''}/assets/images/users/2.jpg`} />
        ...
        <Col xl={3} md={6} lg={6} className="mt-3">
          <Card>
            <Card.Body className="text-center">
              <img className="avatar avatar-xxl bradius cover-image" alt="user 4" src={`${process.env.NODE_ENV === 'production'? basePath : ''}/assets/images/users/4.jpg`} />
              <h4 className="h4 mb-0 mt-3">Mike Rowe-Soft</h4>
              <Card.Text>Web designer</Card.Text>
              <p>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor.</p>
              <Row className="user-social-detail text-center">
        ...
        <Col xl={3} md={6} lg={6} className="mt-3">
          <Card>
            <Card.Body className="text-center">
              <img className="avatar avatar-xxl bradius cover-image" alt='user7' src={`${process.env.NODE_ENV === 'production'? basePath : ''}/assets/images/users/7.jpg`} />
              <h4 className="h4 mb-0 mt-3">Mike Rowe-Soft</h4>
              <Card.Text>Web designer</Card.Text>
              <p>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor.</p>
              <Row className="user-social-detail text-center">
        ...
        <Col xl={3} md={6} lg={6} className="mt-3">
          <Card>
            <Card.Body className="text-center">
              <img className="avatar avatar-xxl bradius cover-image" alt='user 15' src={`${process.env.NODE_ENV === 'production'? basePath : ''}/assets/images/users/15.jpg`} />
              <h4 className="h4 mb-0 mt-3">Mike Rowe-Soft</h4>
              <Card.Text>Web designer</Card.Text>
              <p>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor.</p>
              <Row className="user-social-detail text-center">
                ...
                <Row className="text-center">
                    ...
                    <Card>
                      <Card.Body>
                        <div className="counter-status">
                          <div className="counter-icon bg-primary-gradient">
                  ...
                  <Col xl={3} md={6} lg={6}>
                    <Card>
                      <Card.Body>
                        <div className="counter-status">
                          <div className="counter-icon bg-secondary-gradient">
                    ...
                    <Card>
                      <Card.Body>
                        <div className="counter-statuss">
                          <div className="counter-icon bg-success-gradient">
                  ...
                  <Col xl={3} md={6} lg={6}>
                    <Card>
                      <Card.Body>
                        <div className="counter-status">
                          <div className="counter-icon bg-danger-gradient">
